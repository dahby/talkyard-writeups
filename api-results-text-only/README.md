...
<!-- Insert image of Structured Content interaction -->
...
<!-- Insert image of Structured Content display -->
...
<!-- Insert image of text only display stores screenshot -->
...
<!-- Screenshot of text only deployment display -->
...
<!-- Insert text only store detail screenshot -->